...
const About = () => {
  ...
  return (
    ...
    <div className='main_content_container2 w-11/12 text-cream p-1'>
      <motion.p whileHover={{scale: 1.1, rotate: 1}} whileTap={{scale: 0.9, rotate: -1}} animate={{opacity: 1}} initial={{opacity: 0.1}} className='About_me bg-deep-purple text-center rounded-md'>{language === 'portuguese' ? 'Sobre Mim' : 'About Me'}</motion.p>
