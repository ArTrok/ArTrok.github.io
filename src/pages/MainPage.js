    ...
    <div className='bg-deep-purple bg-opacity-50'>
      ...
      <NavBar />
        <motion.div animate={{opacity: 1}} initial={{opacity: 0}} transition={{ duration: 1 }} className='main_content_container grid'>
            ...
            <motion.h1 whileHover={{ scale: 1.1, rotate: 1}} transition={{ type: "spring", stiffness: 500}} whileTap={{ scale: 0.9, rotate: -1}} id="title" className="text-cream shadow-2xl bg-deep-purple rounded-md my-3 text-center p-4">
