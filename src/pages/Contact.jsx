...
const Contact = () => {
  ...
  return (
    ...
    <motion.div variants={skillVariantMain} animate="visible" initial="hidden" className='main_content_container5 grid gap-5 p-3 justify-items-center bg-light-blue rounded-md'>
      ...
      <motion.textarea animate={{opacity: 1}} initial={{opacity: 0}} aria-label="Message" id="message" placeholder='Mensagem' className='resize-none bg-dark-blue text-cream rounded-md p-2 messagearea' />
