...
const Contact = () => {
  ...
  return (
    ...
    <motion.div variants={skillVariantMain} animate="visible" initial="hidden" className='main_content_container5 grid gap-5 p-3 justify-items-center bg-light-blue rounded-md'>
      ...
      <motion.input animate={{opacity: 1}} initial={{opacity: 0}} type="text" aria-label='Name' placeholder='Nome Completo' className='bg-dark-blue text-cream h-10 rounded-md p-2 name'/>
      ...
      <motion.textarea animate={{opacity: 1}} initial={{opacity: 0}} cols="45" rows="4" aria-label="Message" id="message" placeholder='Mensagem' className='resize-none bg-dark-blue text-cream rounded-md p-2 messagearea' />
