...
const HardSkills = ({icons}) => {
  ...
  return (
    ...
    {icons.map((icon, index) => {
      return (
        <motion.div variants={skillVariant} animate="visible" initial="hidden" drag dragConstraints={{ left: 30, right: 30, top: 30, bottom: 30}} whileHover={{ scale: 1.1, rotate: 3}} transition={{ type: "spring", stiffness: 500}} whileTap={{ scale: 0.9, rotate: -3}} key={index} className={`icon_limit icon_container${index}h text-dark-blue bg-other-purple p-3
